...
1. Add your `entree.mp4` file inside `videos` folder inside `proyecto-deteccion-patentes`
2. Add your `best.pt` file inside `models` folder inside `proyecto-deteccion-patentes`
